...
export const ModalPerroPostulacion = ({ perro, modal, solicitante, cerrarModal, idPostulacion}: ModalPerroProps) => {
                ...
                <div className="modal-dialog  modal-lg mi-modal-personalizado">
                    <div className="modal-content px-3 pb-3">
                        ...
                        <div className="modal-footer border-radius normal-style">
                            <button type="button" className="btn btn-success" onClick={handleChangeState} >
