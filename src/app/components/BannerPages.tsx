    ...
    <>
      <div className="banner-container z-0">
        <div className="d-flex flex-md-row flex-column-reverse row banner-home m-auto w-md-75 w-100 flex-wrap-reverse position-relative ">
          <div className="col-md-6 col p-md-5 px-3 pb-5 d-flex  flex-column text-md-start text-center mt-5">
          ...
          <div className="col-md-6 col p-md-5 px-5 d-flex justify-content-md-end justify-content-center max-w-500">
            <img className="w-75 h-auto object-fit-cover" src={perritoImg} alt="Perro" />
          </div>
        </div>
      </div>
